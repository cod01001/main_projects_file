...
class Student:
    def __init__(self, student_name, student_age, student_course):
        ...
        self.gpa_student = 0
        logging.info(f"Добавили студента:{self.student_name}, {self.student_age} лет на курс {self.student_course}.")
    ...
    def student_save_file(self):
        ...
        with open('student_csv_file.csv', 'w', encoding='UTF-8', newline='') as f:
            ...
            for student in self.students:
                writer.writerow(
                    [student.student_name, student.student_age, student.student_course, student.gpa_student])
